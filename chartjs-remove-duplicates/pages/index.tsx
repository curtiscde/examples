...
import { generateDatasets } from '../tools/generateDatasets'
...
const Home: NextPage<HomeProps> = ({ datasets, filteredDatasets }: HomeProps) => {
  const title = 'ChartJs Data Filtering Example';
  return (
    <>
      <Head>
        <title>{title}</title>
      ...
      <div className='p-6'>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-6">
          <DisplayChart
            ...
            datasets={datasets}
            description='Without filtering, ChartJs shows a data point for every day, even though the data has not changed over several months'
          />
          <DisplayChart
            title={'✅ With filtering'}
            datasets={filteredDatasets}
            description='With filtering in place, ChartJs only shows data points when there is a change on the y axis. This improves the performance, and produces a more readible chart'
          />
        </div>
        <footer className="items-center p-4 footer bg-neutral text-neutral-content">
          ...
          <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
            <Link href="https://www.curtiscode.dev/post/js/chartjs-filtering-duplicate-data">
              <a>
            ...
            <Link href="https://github.com/curtiscde/examples/tree/main/chartjs-remove-duplicates">
              <a>
...
export function getStaticProps() {
  ...
  return { props: { datasets, filteredDatasets } }
}